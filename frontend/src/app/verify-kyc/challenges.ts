...
export const CHALLENGE_POOL: ChallengeSpec[] = [
    // ── Face (12) ─────────────────────────────────────────────────────────────
    { key: 'blink2', label: 'BLINK TWICE', instruction: 'Blink both eyes twice', category: 'face', timeoutMs: 6000 },
    { key: 'look_left', label: 'LOOK LEFT', instruction: 'Turn your head to the LEFT', category: 'face', timeoutMs: 5000 },
    { key: 'look_right', label: 'LOOK RIGHT', instruction: 'Turn your head to the RIGHT', category: 'face', timeoutMs: 5000 },
    { key: 'look_up', label: 'LOOK UP', instruction: 'Tilt your head UP toward the ceiling', category: 'face', timeoutMs: 5000 },
    { key: 'look_down', label: 'LOOK DOWN', instruction: 'Tilt your head DOWN toward the floor', category: 'face', timeoutMs: 5000 },
    { key: 'tilt_left', label: 'TILT LEFT', instruction: 'Tilt your head to your LEFT shoulder', category: 'face', timeoutMs: 5000 },
    { key: 'tilt_right', label: 'TILT RIGHT', instruction: 'Tilt your head to your RIGHT shoulder', category: 'face', timeoutMs: 5000 },
    { key: 'smile', label: 'SMILE', instruction: 'Give a wide natural SMILE', category: 'face', timeoutMs: 6000 },
    { key: 'mouth_open', label: 'OPEN MOUTH', instruction: 'Open your mouth WIDE (like saying "Ahh")', category: 'face', timeoutMs: 5000 },
    { key: 'raise_brows', label: 'RAISE EYEBROWS', instruction: 'Raise your EYEBROWS as high as you can', category: 'face', timeoutMs: 5000 },
    { key: 'nod', label: 'NOD', instruction: 'NOD your head slowly downward', category: 'face', timeoutMs: 6000 },
    { key: 'close_eyes', label: 'CLOSE EYES', instruction: 'Close BOTH EYES and hold for 1 second', category: 'face', timeoutMs: 6000 },
    { key: 'wink_left', label: 'WINK LEFT EYE', instruction: 'WINK your LEFT eye (keep right eye open)', category: 'face', timeoutMs: 6000 },
    { key: 'wink_right', label: 'WINK RIGHT EYE', instruction: 'WINK your RIGHT eye (keep left eye open)', category: 'face', timeoutMs: 6000 },

    // ── Hand (16) ─────────────────────────────────────────────────────────────
    { key: 'show_1', label: '☝️ 1 FINGER', instruction: 'Hold up 1 finger (index) in front of camera', category: 'hand', timeoutMs: 7000 },
    { key: 'show_2', label: '✌️ 2 FINGERS', instruction: 'Hold up 2 fingers — peace sign ✌️', category: 'hand', timeoutMs: 7000 },
    { key: 'show_3', label: '3 FINGERS', instruction: 'Hold up 3 fingers', category: 'hand', timeoutMs: 7000 },
    { key: 'show_4', label: '4 FINGERS', instruction: 'Hold up 4 fingers', category: 'hand', timeoutMs: 7000 },
    { key: 'show_5', label: '🖐️ OPEN HAND', instruction: 'Show your open hand — all 5 fingers', category: 'hand', timeoutMs: 7000 },
    { key: 'thumbs_up', label: '👍 THUMBS UP', instruction: 'Give a THUMBS UP to the camera', category: 'hand', timeoutMs: 7000 },
    { key: 'thumbs_down', label: '👎 THUMBS DOWN', instruction: 'Point THUMBS DOWN to the camera', category: 'hand', timeoutMs: 7000 },
    { key: 'fist', label: '✊ FIST', instruction: 'Make a tight FIST and hold it up', category: 'hand', timeoutMs: 7000 },
    { key: 'open_palm', label: '🤚 SHOW PALM', instruction: 'Show your OPEN PALM flat to the camera', category: 'hand', timeoutMs: 7000 },
    { key: 'wave', label: '👋 WAVE', instruction: 'WAVE your hand side-to-side at the camera', category: 'hand', timeoutMs: 8000 },
    { key: 'point_up', label: '☝️ POINT UP', instruction: 'Point ONE finger straight UP (index only)', category: 'hand', timeoutMs: 7000 },
    { key: 'rock_on', label: '🤘 ROCK ON', instruction: 'Make the rock-on sign 🤘 (index + pinky)', category: 'hand', timeoutMs: 7000 },
    { key: 'call_me', label: '🤙 CALL ME', instruction: 'Show the call-me sign 🤙 (thumb + pinky)', category: 'hand', timeoutMs: 7000 },
    { key: 'ok_sign', label: '👌 OK SIGN', instruction: 'Make the OK sign 👌 (thumb + index circle)', category: 'hand', timeoutMs: 7000 },
    { key: 'l_shape', label: '🔫 L-SHAPE', instruction: 'Make an L-shape with thumb + index finger', category: 'hand', timeoutMs: 7000 },
    { key: 'cross_fingers', label: '🤞 CROSS FINGERS', instruction: 'Cross your index + middle fingers 🤞', category: 'hand', timeoutMs: 7000 },
]

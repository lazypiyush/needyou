                        ...
                        <>
                            ...
                            <div className="flex items-center gap-4">
                                    ...
                                    >
                                        {profile.photoURL ? (
                                            <img
                                                ...
                                                alt={profile['kycData.aadhaarName'] || profile.kycData?.aadhaarName || ''}
                                                className="w-full h-full object-cover"
                                            />
                                        ) : (
                                            <span style={{ color: isDark ? '#60a5fa' : '#2563eb' }}>
                                                {(profile['kycData.aadhaarName'] || profile.kycData?.aadhaarName)?.[0]?.toUpperCase() || '?'}
                                            </span>
                                        )}
                                    </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    <h3 className="text-xl font-bold truncate" style={{ color: textPri }}>{profile['kycData.aadhaarName'] || profile.kycData?.aadhaarName || 'Unknown'}</h3>
                                    {profile.createdAt && (
